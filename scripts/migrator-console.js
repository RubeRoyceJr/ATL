...
for (var i = 0; i < 86401; i++) { await hre.network.provider.request({ method: 'evm_mine' }); console.log(i); }
...
await maiBond.initializeBondTerms( '250', 5 * 24 * 3600, '0', '50', '10000', '8000000000000000','39848408984080')
await lpBond.initializeBondTerms( '100', 5 * 24 * 3600, '0', '50', '10000', '8000000000000000', '7909681796816')
